...
![500](assets/readme-images/Error_Pg/500-Error-pg.jpeg)
...
## Validator Testing
   ...
   ![W3CHtml](assets/readme-images/Validation/W3S-Html-Checker.png)
   ...
   ![W3Ccss](assets/readme-images/Validation/W3S-Css-Validation.png)
   ...
   Whilst most Javascript passed through the tests with no errors, some errors are note and generated due to code used from sources / external Js downloads eg Stipe and thh Boutique Ado Walkthrough .
   
   I decided not to alter these as I had copied these & credited them within the PP as they performe the function that they are intended for and I was unsure if altering them would break the Functionality.

     
   <details><summary>Jshint No Error Country Fields.Js</summary>

   ![Jshint](assets/readme-images/Validation/countryfield.js-Jshint.png)
    
   </details> 

   <details><summary>Jshint No Error edit_product.html.Js</summary>

   ![Jshint](assets/readme-images/Validation/edit_product.html.JS-Jshint.png)
    
   </details>

   <details><summary>Jshint No Error products.html.Js</summary>

   ![Jshint](assets/readme-images/Validation/products.html.JS-JShint.png)
    
   </details>

   <details><summary>Jshint Seven Warnings 3 X currentValue & 4 x allQuantityInputs quantity_input_script.html.Js</summary>

   ![Jshint](assets/readme-images/Validation/quantity_input_script.html-Jshint.png)
    
   </details>

   <details><summary>Jshint Error Undefined Variable stripe_elements.Js</summary>

   ![Jshint](assets/readme-images/Validation/stripe_elements.js-Jshint.png)
    
   </details>

   <details><summary>Jshint Error 2 x warnings & 2x Undefined Variable toast_mailchimp.js.html</summary>

   ![Jshint](assets/readme-images/Validation/toast_mailchimp_js.html-Jshint.png)
   ...
   * Responsiveness tested via Google Dev Tools & Imagery checked Via Am I Responsive
    - Also please see During Features that Mobile pages images have been supplied to show responsiveness
   ...
   * Website tested for Performance, Accessibility, Best Practice and SEO as seen below.

   <details><summary>LightHouse Test Results</summary>

   ![Lighthouse](assets/readme-images/Validation/Lighhouse.png)
    
   </details> 

    Error Affecting Light House 

    <details><summary>Error Affecting Light House :</summary>

   An error in the console is detected that also effects the Light house best practice score.
   This error seems to be generated by the mc-validate.js which is imported & coppied from the Mail Chimp and need to use mailchimp.
   It was decided due to a lack of time & limitted understanding of Mail chimp at this time to leave this error alone as the App is function & have no wish to break it . At a later date this error will be revisted.

   ![Lighthouse](assets/readme-images/Validation/mc-validate.js-Uncaught-Error.png)
...
## Credits
   ...
   * Copy Right - Our Copy Right was create with the help of Easy Legal Docs Generator. https://easylegaldocs.com/templates/notices/copyright-notice/
